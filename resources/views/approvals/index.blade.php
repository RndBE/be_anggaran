<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="text-xl font-bold text-foreground">{{ __('Kotak Masuk Persetujuan') }}</h2>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="py-14 text-center">
                                        ...
                                        <p class="text-sm font-medium text-foreground">Semua sudah selesai!</p>
                                        <p class="text-xs text-muted-foreground mt-1">Tidak ada persetujuan yang menunggu
                                            perhatian Anda.</p>
                                    </td>
                                </tr>
                            @endforelse
