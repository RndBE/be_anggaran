<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold text-foreground">{{ __('Review Request') }}</h2>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="card p-6">
                    <h3 class="card-title mb-4">Request Details</h3>
                    <div class="separator mb-4"></div>
                    <div class="space-y-4">
                        <div>
                            <p class="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Requested By
                            </p>
                        ...
                        <div>
                            <p class="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Total Amount
                            </p>
                            <p class="text-2xl font-bold text-primary mt-1">Rp
                                {{ number_format($approval->request->total_amount, 0, ',', '.') }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Items
                                Breakdown</p>
                            <div class="space-y-2">
                ...
                <div>
                    @auth
                        ...
                        @if($canAct)
                            <div class="card p-6">
                                <h3 class="card-title mb-1">Your Decision</h3>
                                <p class="card-description">Review the request and make your approval decision</p>
                                ...
                                <form action="{{ route('approvals.update', $approval->id) }}" method="POST" class="space-y-5">
                                    ...
                                    <div class="form-group">
                                        <x-input-label>Step Designation</x-input-label>
                                        <div
                                    ...
                                    <div class="form-group">
                                        <x-input-label>Decision</x-input-label>
                                        <div class="mt-1 space-y-2">
                                            <label
                                                ...
                                                <div>
                                                    <p class="text-sm font-semibold text-green-700">✓ Approve</p>
                                            ...
                                            <label
                                                ...
                                                <div>
                                                    <p class="text-sm font-semibold text-amber-700">↩ Request Revision</p>
                                            ...
                                            <label
                                                ...
                                                <div>
                                                    <p class="text-sm font-semibold text-destructive">✕ Reject</p>
                                    ...
                                    <div class="form-group">
                                        <x-input-label for="comments">Comments / Reasons</x-input-label>
                                    ...
                                    <div class="flex justify-end gap-3 pt-2 border-t border-border">
                                        <a href="{{ route('approvals.index') }}" class="btn-outline">Cancel</a>
                                        <button type="submit" class="btn-default">Submit Decision</button>
                                    </div>
                                </form>
                            </div>
                        @else
                            <div class="card p-8 flex flex-col items-center justify-center text-center">
                                ...
                                <p class="font-semibold text-foreground">Viewing Only</p>
                                <p class="text-sm text-muted-foreground mt-2">
                                    This approval step requires the
